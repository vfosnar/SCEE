...
class AddPlaceVatin(
...
) : OsmElementQuestType<PlaceVatinAnswer> {
    ...
    override val wikiLink = "Key:ref:vatin"
    override val icon = R.drawable.ic_quest_general_ref
    override val isReplacePlaceEnabled = true
    override val achievements = listOf(CITIZEN)

    override fun getTitle(tags: Map<String, String>) = R.string.quest_placeVatin_title
    ...
    override fun createForm() = AddPlaceVatinForm()

    override fun applyAnswerTo(answer: PlaceVatinAnswer, tags: Tags, geometry: ElementGeometry, timestampEdited: Long) {
        when (answer) {
            is NoPlaceVatinSign -> {
