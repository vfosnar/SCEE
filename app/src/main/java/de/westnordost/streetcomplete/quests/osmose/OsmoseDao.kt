...
class OsmoseDao(
    ...
    suspend fun download(bbox: BoundingBox) {
        ...
        try {
            ...
            // TODO 1: problem: title/subtitle can contain ',', fucking up the simple csv structure
            //  either parse while checking ", or switch to other format
